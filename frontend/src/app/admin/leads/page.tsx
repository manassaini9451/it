...
export default function AdminLeadsPage() {
  ...
  const fetchLeads = useCallback(async () => {
    ...
    try {
      ...
      setLeads(res.data?.data?.leads||demoLeads);
      setTotal(res.data?.data?.total||demoLeads.length);
...
const demoLeads = [
  {_id:'1',firstName:'Sarah',lastName:'Johnson',email:'sarah@techstartup.com',phone:'+1 555 0101',company:'TechStartup Inc',service:'SEO Services',budget:'$1000-5000',message:'Looking to improve organic rankings.',status:'new',source:'organic',score:85,createdAt:STATIC_DEMO_DATE},
  {_id:'2',firstName:'Michael',lastName:'Chen',email:'mchen@eshop.com',phone:'+1 555 0202',company:'E-Shop Pro',service:'E-Commerce SEO',budget:'$2000-8000',status:'contacted',source:'referral',score:72,createdAt:STATIC_DEMO_DATE_2},
  {_id:'3',firstName:'Emily',lastName:'Roberts',email:'emily@local.com',company:'Local Hub',service:'Local SEO',budget:'$500-1500',status:'qualified',source:'google',score:90,createdAt:STATIC_DEMO_DATE_3},
  {_id:'4',firstName:'David',lastName:'Park',email:'dpark@saas.com',company:'SaaS Co',service:'Technical SEO',budget:'$3000-10000',status:'proposal',source:'linkedin',score:78,createdAt:STATIC_DEMO_DATE_4},
  {_id:'5',firstName:'Lisa',lastName:'Martinez',email:'lisa@retail.com',company:'Retail Chain',service:'Enterprise SEO',budget:'$10000+',status:'won',source:'direct',score:95,createdAt:STATIC_DEMO_DATE},
];
